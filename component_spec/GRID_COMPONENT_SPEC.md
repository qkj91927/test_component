...
| A5 | 平铺·圆形5列 | 5 | 64×64 | 50% | 12px | 121px | 圆形 |
| A6 | 平铺·圆形6列 | 6 | 60×60 | 50% | 10px | 114px | 圆形 |
| A7 | 平铺·圆形7列 | 7 | 52×52 | 50% | 10px | 106px | 圆形 |

### 横滑模式（A8 - A17）

| ID | 名称 | 可见列数 | 总列数 | 缩略图尺寸 | 圆角 | 字号 | 容器高度 | 形状 |
|----|------|---------|-------|-----------|------|------|---------|------|
| A8 | 横滑·正方形3列 | 3 | 4 | 112×112 | 16px | 14px | 172px | 正方形 |
| A9 | 横滑·正方形4+列 | 4 | 5 | 80×80 | 12px | 12px | 137px | 正方形 |
| A10 | 横滑·圆形4列 | 4 | 4 | 64×64 | 50% | 12px | 109px | 圆形 |
| A11 | 横滑·圆形5列 | 5 | 5 | 64×64 | 50% | 12px | 109px | 圆形 |
| A12 | 横滑·圆形6列 | 6 | 6 | 60×60 | 50% | 10px | 112px | 圆形 |
| A13 | 横滑·圆形7列 | 7 | 7 | 52×52 | 50% | 10px | 104px | 圆形 |
| A14 | 横滑·横版2列 | 2 | 2 | 190×269 | 16px | 14px | 329px | 横版 |
| A15 | 横滑·竖版2+列 | 2 | 3 | 172×256 | 15.2px | 14px | 316px | 竖版 |
| A16 | 横滑·竖版3列 | 3 | 3 | 120×168 | 16px | 14px | 228px | 竖版 |
| A17 | 横滑·竖版3+列 | 3 | 4 | 108×152 | 16px | 14px | 212px | 竖版 |
