...
| :--- | :--- | :--- |
| R0 | 为空 / None | 无右侧内容 |
| R1 | 跳转 / Detail | 可选 17px 灰色辅助信息文字 (`rgba(60, 60, 67, 0.76)`) + 16px 右箭头图标 |
| R2 | 辅助信息+下拉菜单 / Dropdown | 17px 灰色文字 + 16px 下拉箭头图标 |
| R3 | 头像 / Avatar | 32px 圆形头像 + 16px 右箭头图标，间距 8px |
| R4 | 开关 / Switch | 44×26px 胶囊开关，开启态背景 `#0099FF` |
| R5 | 勾选 / Checkbox | 20px 勾选图标（蓝色 `#0099FF`） |
